# Management Portal Bug Report & Test Failures

## Systemic Failures
- **Login Authentication/Redirection Timeout**: All 7 role-based E2E tests for the Management Portal failed in the `beforeEach` hook. 
