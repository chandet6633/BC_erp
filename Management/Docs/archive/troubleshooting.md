# BC Auto Management — Troubleshooting Guide

> Solutions for common issues encountered while working on the BC Auto Management codebase.
...
# Rebuild
docker compose build management --no-cache
