const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./job-B1SpiMD3.js","./inventory-DHMdvGMB.js","./quotation-DTJarnbx.js","./document-factory-B3Z2MMKN.js","./invoice-otoSBhSv.js","./receipt-Bed1H-Ib.js","./credit-note-DJCGKdTA.js","./requisition-Dg2NTVP4.js","./stock-return-DtPRWw3A.js","./stock-transfer-DC8oeilD.js","./stock-adjust-UNAdPLBE.js","./goods-receipt-Bjf17Y5_.js","./purchase-invoice-CVP4xc5S.js","./purchase-cn-Bce4TkYU.js","./payment-ZvzY4YYz.js","./withholding-tax-BtJc2_1U.js","./master-company-EGEBVaKK.js","./master-factory-DM6l7Huy.js","./master-customer-BSRnkNYQ.js","./master-vehicle-D3peJOCD.js","./master-product-CdyFPtOQ.js","./master-brand-CebtJiQv.js","./master-group-znVJumX5.js","./master-vendor-BdfSYrzO.js","./report-sales-wVkrhpAi.js","./chart-bvgMksnO.js","./report-inventory-B4Vdlx_N.js","./report-finance-DsZDBb6_.js","./kanban-CTxrmK6i.js","./kanban-DwCSKmbi.css"])))=>i.map(i=>d[i]);
...
`);return se(s)}function V(e,t=80,n=24){if(!e||e.length<2)return"";const s=Math.max(...e,1),o=Math.min(...e,0),r=s-o||1,a=t/(e.length-1),i=e.map((v,c)=>{const y=c*a,p=n-(v-o)/r*(n-4)-2;return`${y.toFixed(1)},${p.toFixed(1)}`}).join(" "),l=e[0],f=e[e.length-1],u=f>l?"#22c55e":f<l?"#ef4444":"#94a3b8";return`<svg width="${t}" height="${n}" viewBox="0 0 ${t} ${n}" 
    ...
    `,document.body.appendChild(t);const n=()=>{localStorage.setItem("mungkhud_changelog_version",Ae),t.remove()};t.querySelector("#changelogClose").addEventListener("click",n),t.querySelector("#changelogDismiss").addEventListener("click",n),t.querySelector("div").addEventListener("click",o=>{o.target===t.querySelector("div")&&n()})}const mt={dashboard:$e,job:()=>m(()=>import("./job-B1SpiMD3.js"),__vite__mapDeps([0,1]),import.meta.url).then(e=>e.initJobPage),quotation:()=>m(()=>import("./quotation-DTJarnbx.js"),__vite__mapDeps([2,3,1]),import.meta.url).then(e=>e.initQuotationPage),invoice:()=>m(()=>import("./invoice-otoSBhSv.js"),__vite__mapDeps([4,3,1]),import.meta.url).then(e=>e.initInvoicePage),receipt:()=>m(()=>import("./receipt-Bed1H-Ib.js"),__vite__mapDeps([5,3,1]),import.meta.url).then(e=>e.initReceiptPage),"credit-note":()=>m(()=>import("./credit-note-DJCGKdTA.js"),__vite__mapDeps([6,3,1]),import.meta.url).then(e=>e.initCreditNotePage),"stock-list":()=>m(()=>import("./stock-list-CQ4ZWRJf.js"),[],import.meta.url).then(e=>e.initStockListPage),requisition:()=>m(()=>import("./requisition-Dg2NTVP4.js"),__vite__mapDeps([7,3,1]),import.meta.url).then(e=>e.initRequisitionPage),"stock-return":()=>m(()=>import("./stock-return-DtPRWw3A.js"),__vite__mapDeps([8,3,1]),import.meta.url).then(e=>e.initStockReturnPage),"stock-transfer":()=>m(()=>import("./stock-transfer-DC8oeilD.js"),__vite__mapDeps([9,3,1]),import.meta.url).then(e=>e.initStockTransferPage),"stock-adjust":()=>m(()=>import("./stock-adjust-UNAdPLBE.js"),__vite__mapDeps([10,3,1]),import.meta.url).then(e=>e.initStockAdjustPage),"goods-receipt":()=>m(()=>import("./goods-receipt-Bjf17Y5_.js"),__vite__mapDeps([11,3,1]),import.meta.url).then(e=>e.initGoodsReceiptPage),"purchase-invoice":()=>m(()=>import("./purchase-invoice-CVP4xc5S.js"),__vite__mapDeps([12,3,1]),import.meta.url).then(e=>e.initPurchaseInvoicePage),"purchase-cn":()=>m(()=>import("./purchase-cn-Bce4TkYU.js"),__vite__mapDeps([13,3,1]),import.meta.url).then(e=>e.initPurchaseCNPage),payment:()=>m(()=>import("./payment-ZvzY4YYz.js"),__vite__mapDeps([14,3,1]),import.meta.url).then(e=>e.initPaymentPage),"withholding-tax":()=>m(()=>import("./withholding-tax-BtJc2_1U.js"),__vite__mapDeps([15,3,1]),import.meta.url).then(e=>e.initWithholdingTaxPage),"master-company":()=>m(()=>import("./master-company-EGEBVaKK.js"),__vite__mapDeps([16,17]),import.meta.url).then(e=>e.initMasterCompanyPage),"master-customer":()=>m(()=>import("./master-customer-BSRnkNYQ.js"),__vite__mapDeps([18,17]),import.meta.url).then(e=>e.initMasterCustomerPage),"master-vehicle":()=>m(()=>import("./master-vehicle-D3peJOCD.js"),__vite__mapDeps([19,17]),import.meta.url).then(e=>e.initMasterVehiclePage),"master-product":()=>m(()=>import("./master-product-CdyFPtOQ.js"),__vite__mapDeps([20,17]),import.meta.url).then(e=>e.initMasterProductPage),"master-brand":()=>m(()=>import("./master-brand-CebtJiQv.js"),__vite__mapDeps([21,17]),import.meta.url).then(e=>e.initMasterBrandPage),"master-group":()=>m(()=>import("./master-group-znVJumX5.js"),__vite__mapDeps([22,17]),import.meta.url).then(e=>e.initMasterGroupPage),"master-vendor":()=>m(()=>import("./master-vendor-BdfSYrzO.js"),__vite__mapDeps([23,17]),import.meta.url).then(e=>e.initMasterVendorPage),"master-lookup":()=>m(()=>import("./master-lookup-O9l8a9za.js"),[],import.meta.url).then(e=>e.initMasterLookupPage),"report-sales":()=>m(()=>import("./report-sales-wVkrhpAi.js"),__vite__mapDeps([24,25]),import.meta.url).then(e=>e.initReportSalesPage),"report-inventory":()=>m(()=>import("./report-inventory-B4Vdlx_N.js"),__vite__mapDeps([26,25]),import.meta.url).then(e=>e.initReportInventoryPage),"report-finance":()=>m(()=>import("./report-finance-DsZDBb6_.js"),__vite__mapDeps([27,25]),import.meta.url).then(e=>e.initReportFinancePage),forms:()=>m(()=>import("./forms-sDkY6WbM.js"),[],import.meta.url).then(e=>e.initFormsPage),settings:()=>m(()=>import("./settings-C4DlwwCs.js"),[],import.meta.url).then(e=>e.initSettingsPage),"user-permissions":()=>m(()=>import("./user-permissions-BD-CUTW4.js"),[],import.meta.url).then(e=>e.initUserPermissionsPage),"master-branch":()=>m(()=>import("./master-branch-D4JhU9yX.js"),[],import.meta.url).then(e=>e.initBranchPage),kanban:()=>m(()=>import("./kanban-CTxrmK6i.js"),__vite__mapDeps([28,1,29]),import.meta.url).then(e=>e.initKanbanPage)},ft="dashboard";function j(){return window.location.hash.replace("#/","").split("?")[0]||ft}async function Q(e){const t=L();if(e==="login"){yt();const l=document.getElementById("pageContent");l.innerHTML="",at(l);return}if(!t){window.location.hash="#/login";return}if(t.role&&["employee","employee_main","employee_sup","sa"].includes(t.role)&&isEmployeeRestricted(e)){K();const l=document.getElementById("pageContent");l.innerHTML=`
