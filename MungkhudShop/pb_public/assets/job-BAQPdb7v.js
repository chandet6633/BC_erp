import{f as h,c as tt,a as D,g as et,s as I,b as ot,u as F,d as K,e as k,h as U,i as at,j as J,r as st,k as lt,l as rt,m as H,n as it,o as ct,p as nt,q as T}from"./index-9Z-6SckO.js";import{B as Q,p as B}from"./inventory-BROWFZn2.js";let V=[],z=null,O=null,N=null,G=null,$=null,P=null;function L(){return{currentItems:V,editingId:z,plateAC:O,customerAC:N,vatToggle:G}}function dt(t){V=t}function W(t){z=t}function ut(t){O=t}function bt(t){N=t}function mt(t){G=t}function vt(){V=[],z=null,O=null,N=null,G=null,yt()}async function pt(){if(!$){const[t,e]=await Promise.all([h("products",{}),h("stock_ledgers",{})]);$=t,P={},e.forEach(i=>{P[i.product_id]=(P[i.product_id]||0)+(i.qty||0)})}return{products:$,stockMap:P}}function yt(){$=null,P=null}function R(t,e=null,i=1){const c=t.querySelector("#jobItemsBody");c.querySelector(".grid-empty")&&(c.innerHTML="");const a=document.createElement("tr"),n=e&&(e.product_name||e.product_id)||"";a.innerHTML=`
        <td>${i}</td>
