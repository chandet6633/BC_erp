import{g as q,f as k,s as _,b as D,q as E,l as S,e as w,p as M,u as K}from"./index-9Z-6SckO.js";import{p as z}from"./inventory-BROWFZn2.js";const y=[{id:"open",label:"รับงาน",color:"#3b82f6",icon:"inbox"},{id:"in_progress",label:"กำลังทำ",color:"#f59e0b",icon:"build"},{id:"pending_review",label:"รอตรวจ",color:"#8b5cf6",icon:"fact_check"},{id:"closed",label:"เสร็จ",color:"#22c55e",icon:"check_circle"}];let p=null;function R(t){t.innerHTML=`
