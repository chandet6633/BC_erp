import{s as l}from"./index-9Z-6SckO.js";const d=[{id:"provinces",label:"จังหวัด",icon:"location_on"},{id:"banks",label:"ธนาคาร",icon:"account_balance"},{id:"credit_cards",label:"บัตรเครดิต",icon:"credit_card"},{id:"tax_categories",label:"ประเภทภาษี",icon:"percent"},{id:"prefixes",label:"คำนำหน้า",icon:"badge"},{id:"units",label:"หน่วยนับ",icon:"straighten"},{id:"product_groups",label:"กลุ่มสินค้า",icon:"category"},{id:"job_types",label:"ประเภทงาน",icon:"build"}];function o(e){e.innerHTML=`
