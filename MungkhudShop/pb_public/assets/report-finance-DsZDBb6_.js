import{f as w,e as C,l as i,r as D}from"./index-XszaqNmQ.js";import{e as H,C as E,B as I,a as O,b as P,L as V,p as A,c as B}from"./chart-bvgMksnO.js";E.register(I,O,P,V,A,B);function z(s){var h,f;const g=new Date().toISOString().slice(0,10),q=new Date(Date.now()-30*864e5).toISOString().slice(0,10);s.innerHTML=`
