import{f as j,e as x,l as c,r as D}from"./index-XszaqNmQ.js";import{e as M,C as k,B as T,a as R,b as F,L as $,p as A,c as P}from"./chart-bvgMksnO.js";k.register(T,R,F,$,A,P);function O(t){var f,S;const p=new Date().toISOString().slice(0,10),E=new Date(Date.now()-30*864e5).toISOString().slice(0,10);t.innerHTML=`
