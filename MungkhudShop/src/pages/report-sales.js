...
export function initReportSalesPage(container) {
    ...
    async function loadReport() {
        ...
        try {
            // BUG 19 FIX: Apply branch filter to prevent cross-branch revenue leakage in sales reports
    ...
    // BUG 74 FIX: Do NOT auto-load report on mount. Wait for user to press "ดูรายงาน".
    // Previously, every page navigation triggered a full data fetch for the last 30 days.
}
