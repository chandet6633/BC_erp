# BC Auto Portal — System Architecture & Backend State
...
services:
  portal:
    build: ./Portal
    ports: ["8092:8092"]
    volumes: ["./Portal/pb_data:/pb/pb_data"]
    restart: unless-stopped
```

Data persists in `./Portal/pb_data/` on the host. Container rebuilds don't affect data. (`docker-compose.yml:20-38`)
