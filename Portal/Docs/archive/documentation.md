...
A portal webapp for **BC Auto Xperience** (auto repair business). Handles revenue tracking, expense portal, P&L analysis, HR (check-in/payroll), audit logging, and branch operations across 3+ branches in Thailand.
...
4. **Validation Wizards**: Multi-step input with green/red indicators (see `user-portal.html`).
