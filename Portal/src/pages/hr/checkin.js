...
import { fetchBranchMetadata } from '@shared/branch-metadata.js';
...
async function loadRoster() {
    ...
    try {
        const [empRecords, branchRecords] = await Promise.all([
            ...
            fetchBranchMetadata({ includeAll: false, force: true })
        ]);
        ...
        const branches = branchRecords.map(b => b.branch_id);
