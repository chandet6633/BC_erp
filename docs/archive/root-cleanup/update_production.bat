...
REM ===================================================================
REM
REM  This script safely updates both containers (Portal and
...
if exist "%~dp0Portal\pb_data\data.db" (
    echo  [OK] Portal database exists.
) else (
    echo  [INFO] Portal database will be created on first run.
)
...
echo.
echo   Portal:   http://localhost:8092
